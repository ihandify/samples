# iHandify Sample Application in Python
...
```bash
git clone https://github.com/ihandify/python-sample.git
cd python-sample
```
...
Modify the port mapping in `docker-compose.yml` or stop the application currently using port 8010.
