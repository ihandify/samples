# iHandify Sample Application in DotNet (C#)
...
```bash
git clone https://github.com/ihandify/csharp-sample.git
cd csharp-sample
```
...
Modify the port mapping in `docker-compose.yml` or stop the application currently using port 8050.
