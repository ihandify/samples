...
```bash
git clone https://github.com/ihandify/java-sample.git
cd java-sample
```
...
### ポート 8060 がすでに使用されている場合

`docker-compose.yml` 内のポートマッピングを変更するか、現在ポート 8060 を使用している他のアプリケーションを停止してください。
